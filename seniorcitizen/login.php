...
?>
    <head>
        <meta charset="UTF-8">
        <title>Barangay Balingasag  Senior Citizen||  Information System</title>
    ...
    <body class="skin-black">
      ...
      <?php
        ...
        { 
            ...
            $user = mysqli_query($con, "SELECT * from SeniorCitizen where username = '$username' and password = '$password' ");
