...
<form class="form-horizontal" method="post" enctype="multipart/form-data">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        $edit_query = mysqli_query($con,"SELECT *, form.id AS scId, form.firstName AS scFirstName, form.lastName AS scLastName from form left join purok on purok.id = form.purokId where form.id = '".$row['id']."' ");
        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input name="seniorCitizenID" class="form-control input-sm" type="text" placeholder="senior citizen id" value="'.$seniorCitizenID.'"required/>
                    </div>                                   
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="firstName" class="form-control input-sm col-sm-4" type="text" placeholder="Firstname" value="'.$firstName.'"required/>
                    </div>
                    <div class="col-sm-4">
                        <input name="middleName" class="form-control input-sm col-sm-4" type="text" placeholder="Middlename" value="'.$middleName.'"required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="contactNumber" class="form-control input-sm input-size" type="text" placeholder="Contact Number" value="'.$contactNumber.'"required/>
                </div>             
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="monthlyPension" class="form-control input-sm input-size" type="text" placeholder="Monthly Pension" value="'.$monthlyPension.'"required/>
                </div>            
                ...
                <div class="form-group">
                    ...
                    <input name="contactPersonNumber" class="form-control input-sm input-size" type="text" placeholder="Contact Person Number" value="'.$contactPersonNumber.'"required/>
                </div>            
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary btn-sm" name="btn_approve" value="Save"/>
        </div>
    </div>
  </div>
</form>
