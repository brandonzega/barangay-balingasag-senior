                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        ?>
                                         ...
                                         <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#approvemodal"><i class="fa fa-user-plus" aria-hidden="true"></i> Approve</button>  
                                        <?php 
                                            // if(!isset($_SESSION['staff']))
                                ...
                                <form method="post"  enctype="multipart/form-data">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                 $squery = mysqli_query($con, "SELECT * from form");
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['id'].'" /></td>
                                                        ...
                                                        <td><button class="btn btn-primary btn-sm" data-target="#editModal'.$row['id'].'" data-toggle="modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> View Request</button></td>
                                                    </tr>
                                                    ';
