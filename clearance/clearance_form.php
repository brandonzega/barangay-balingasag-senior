        ...
        <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="../../img/tan-awan.png" style="width:90%;height:164px;"/></center>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    <div class="pull-left" style="font-size: 16px; margin-left: 100px;"><b><center>
                        ...
                        Municipality of Kabankalan<br>
                        Province of Negros Occidental<br>
                        BARANGAY TAN-AWAN<br>
                        Tel. 123-4567<br></b></center><br><br><br>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <p style="text-indent:40px;text-align: justify;">This is to certify that the person whose photo, signature and right thumb mark appear herein, is a resident of Barangay Tan-awan, Kabankalan City, Negros Occidental and that the person had requested a criminal check from this office following is/are our findings.</p>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p><b>
                                    ...
                                    ISSUED AT: <u>BARANGAY TAN-AWAN OFFICE</u><br>
