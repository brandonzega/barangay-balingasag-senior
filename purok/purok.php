                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addPurokModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Purok Leader</button>  
                                        <?php 
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $squery = mysqli_query($con, "select * from purok");
