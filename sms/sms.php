                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#sendSMS"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send SMS</button>  
                                        <?php 
                                ...
                                <form method="post"  enctype="multipart/form-data">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $squery = mysqli_query($con, "SELECT * from sms_logs");
